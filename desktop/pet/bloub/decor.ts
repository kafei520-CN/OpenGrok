...
/**
 * Unread pastille. The video's `#2496e8` disappears on blue bodies and busy
 * desktops; a hot orange-red stays obvious on every shipped skin.
 */
export const NOTIF_INK = '#FF3B1A'
/** Alias kept so vendored samples that still name the video swatch compile. */
export const NOTIF_BLUE = NOTIF_INK
