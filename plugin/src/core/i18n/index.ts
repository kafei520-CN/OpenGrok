...
export const EN = {
  ...
  ogPluginsHint:
    'Local scripts in ~/.opengrok/plugins that restyle the UI or wrap the host. Not Grok marketplace plugins.',
  ogPluginsEmpty: 'No OpenGrok plugins yet. Put a folder with ui.js, host.js, or style.css in ~/.opengrok/plugins.',
  ...
  cardExplore: 'Explore and understand the code',
...
export const ZH: Record<StringKey, string> = {
  ...
  ogPluginsHint:
    '放在 ~/.opengrok/plugins 的本地脚本，用来改界面或夹宿主逻辑。不是 Grok 市场插件。',
  ogPluginsEmpty: '还没有 OpenGrok 插件。在 ~/.opengrok/plugins 下建文件夹，放入 ui.js、host.js 或 style.css。',
  ...
  revertNone: '这一轮没有可还原的��件',
  revertFailed: '{n} 个文件未���还原',
  revertWorking: '正在��原文件…',
  grokDiff: 'Grok Diff',
  reviewTitle: '更改审查',
  reviewAll: '全部改动',
  reviewSearch: '搜索文件...',
  ...
  remoteFileBinary: '这是二进制文件。若本机 IDE ���着，已在 IDE 里打开。',
