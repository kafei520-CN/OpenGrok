...
export const EN = {
  ...
  settingsTheme: 'Theme',
  settingsThemeHint: 'Colors, a panel material (frosted, solid, or Endfield), and an optional image behind the chat.',
  ...
  themeResetDefault: 'Reset default theme',
  themeFont: 'Font',
  ...
  themeSurface: 'Panel',
  themeSurfaceHint: 'Pick a panel material. Frosted glass blurs the wallpaper. Endfield is a HUD skin; colors stay customizable.',
  ...
  settingsTerminalHint: 'Allow slash commands, skills, and shell tools. Off by default. Applies without restarting.',
  ...
  settingsSkillsBundled: 'Built-in · office',
  ...
  settingsExtHint: 'Grok CLI plugins, marketplace, hooks, and workflows — not OpenGrok UI plugins.',
  settingsPlugins: 'Grok plugins',
  settingsPluginsEmpty: 'No Grok CLI plugins loaded in this session.',
  ogPlugins: 'OpenGrok plugins',
  ogPluginsHint:
    'Local scripts in ~/.opengrok/plugins that restyle the UI or wrap the host. Folders or .zip packs with ui.js, host.js, or style.css all load. Not Grok marketplace plugins.',
  ogPluginsEmpty: 'No OpenGrok plugins yet. Put a folder or a .zip with ui.js, host.js, or style.css in ~/.opengrok/plugins.',
  ogPluginsOpenDir: 'Open plugins folder',
  ogPluginsReload: 'Reload plugins',
  ogPluginsHasUi: 'UI',
  ogPluginsHasHost: 'Host',
  dockTools: 'Tools',
  dockTerminal: 'Terminal',
  dockBrowser: 'Browser',
  dockF12: 'Toggle DevTools',
  dockUrlPlaceholder: 'Type a URL and press Enter',
  dockBrowserEmpty: 'Paste or type a URL to open a page.',
  dockCopyUrl: 'Copy URL',
  dockOpenExternal: 'Open in browser',
  dockTermPlaceholder: 'Type a command',
  dockCollapse: 'Collapse panel',
  dockNewTab: 'New tab',
  dockResize: 'Drag to resize',
  dockOpenTab: 'Open a tab',
  dockOpenTabHint: 'Choose a tab to open in the side panel.',
  dockCloseTab: 'Close tab',
  dockCloseOthers: 'Close other tabs',
  dockCloseAll: 'Close all tabs',
  dockSearchTabs: 'Search tabs...',
  dockOpenTabs: 'Open tabs',
  dockRecentTabs: 'Recently closed',
  dockAgeMin: '{n}m',
  dockAgeHour: '{n}h',
  dockAgeDay: '{n}d',
  close: 'Close',
  ...
  sessionsRenameHint: 'Session name',
  ...
  goalClose: 'Close goal',
  goalBarRunning: 'Running goal',
  goalBarPaused: 'Paused goal',
  goalEdit: 'Edit goal',
  goalEditHint: 'Edit the goal and press send',
  goalStatus: 'Goal status',
  goalStartHint: 'Describe the goal and press send',
  goalFollowHint: 'Send a note to the running goal',
  goalResumeHint: 'Send to resume, or press play',
  goalRunningHint: 'Goal is running. Stop only pauses it.',
  ...
  cardExplore: '摸清仓库结构与实现',
  cardBuild: 'Build a feature, app, or tool',
  cardReview: 'Review code and propose edits',
  cardFix: 'Fix failures and regressions',
  recent: 'Recent',
  you: 'You',
  grok: 'Grok',
  ...
  appName: 'OpenGrok',
  appTag: 'Local workbench for Grok Build',
  railChat: 'Chat',
  railMcps: 'MCP Servers',
  railPlugins: 'Plugins',
  railWorktrees: 'Worktrees',
  railMemory: 'Memory',
  railConfig: 'Config & Auth',
  railProject: 'Projects',
  railPickProject: 'Open folder',
  railNoProject: 'No folder selected',
  railSearch: 'Search sessions',
  railSearchEmpty: 'No matching sessions',
  railHistory: 'History',
  homeHintDesk: 'Click a card to fill the box, then send. / commands, @ files.',
  shortcutNew: 'New chat (Ctrl+N)',
  shortcutSettings: 'Settings (Ctrl+,)',
  shortcutFind: 'Search chats (Ctrl+K)',
  shortcutComposer: 'Focus composer (Ctrl+L)',
  winMin: 'Minimize',
  winMax: 'Maximize',
  winRestore: 'Restore',
  winClose: 'Close',
  ...
  setAbout: 'About',
  setStatus: 'Status',
  setSignedIn: 'Signed in as {name}',
  setSignedOut: 'Not signed in',
  setQuota: 'Usage',
  setThemePair: 'Theme',
  setInk: 'Ink',
  setPaper: 'Paper',
  ...
  setColors: 'Colors',
  petTitle: 'Pet',
  petHint: 'Always-on-top companion. Single click plays an emote; double-click opens the app.',
  petEnable: 'Show pet',
  petSize: 'Size',
  petSizeSm: 'Small',
  petSizeMd: 'Medium',
  ...
  petLook: 'Look',
  petBubbles: 'Bubbles',
  petBubblesOn: 'Task chips',
  petBubblesHint: 'Show a chip above the mark while Grok is working.',
  petInk: 'Ink',
  petPaper: 'Paper',
  petIce: 'Ice',
  petMoss: 'Moss',
  ...
  setAccent: 'Accent',
  setMainColorHint: 'Text and chrome pick black or white against this color.',
  setUnofficial: 'Unofficial desktop workbench for the Grok Build CLI. Not an xAI product.',
  setAboutLicense: 'Apache-2.0. Agent runtime is the grok CLI on this machine.',
  setBackApp: 'Back to app',
  setSearch: 'Search settings…',
  setGroupPerson: 'Personal',
  setGroupSystem: 'System',
  setGeneral: 'General',
  setCli: 'CLI / Runtime',
  setOfficial: 'Official account',
  setProviders: 'Custom providers',
  setAccountHint: 'Sign in with Grok Build to see SuperGrok quota and official models.',
  setQuotaLeft: '{n}% left',
  setQuotaUsed: 'Used {n}%',
  setQuotaReset: 'Resets {when}',
  setQuotaWeb: 'View usage on the web',
  setQuotaManage: 'Manage subscription',
  setSwitchAccount: 'Switch account',
  setWhatsNew: "What's new",
  setTour: 'Product tour',
  setThemeMenu: 'Theme',
  heatTitle: 'Activity',
  heatDay: 'Daily',
  heatWeek: 'Weekly',
  heatCumul: 'Total',
  heatTotal: 'Total tokens',
  heatPeak: 'Peak tokens',
  heatLongest: 'Longest chat',
  heatStreak: 'Current streak',
  heatLongestStreak: 'Longest streak',
  heatDays: '{n} days',
  heatLess: 'Less',
  heatMore: 'More',
  heatEmpty: 'No local activity yet',
  heatLoading: 'Loading activity…',
  heatTip: '{date} · {tokens} tokens · {sessions} chats',
  setVersion: 'Version {v}',
  updateTitle: 'Updates',
  updateCheck: 'Check for updates',
  updateChecking: 'Checking for updates…',
  updateIdle: 'Check GitHub for a newer build.',
  updateLatest: 'You are up to date.',
  updateAvailable: 'Version {v} is available.',
  updateDownload: 'Download',
  updateDownloading: 'Downloading {p}%',
  updateReady: 'Version {v} is ready. Restart to install.',
  updateNow: 'Restart and install',
  updateAuto: 'Automatic updates',
  updateAutoHint: 'Download new versions in the background. Install when you quit, or tap Restart.',
  updateFailed: 'Update failed: {e}',
  updateDev: 'Updates run in installed builds, not in dev mode.',
  ...
  placeholderDesk: 'Message OpenGrok, or type /',
  loginTitleDesk: 'Sign in to OpenGrok',
  loginBodyDesk: 'Same grok.com login as the CLI. SuperGrok, X Premium+, or an xAI API key.',
} as const;
...
export const ZH: Record<StringKey, string> = {
  ...
  settingsTheme: '主题',
  settingsThemeHint: '主色、副色、背景色，以及毛玻璃 / 纯色 / 终末地面板。可选图片铺在对话框后面。',
  settingsRemote: '远程访问',
  ...
  themeSurface: '面板',
  themeSurfaceHint: '选择面板材质。毛玻璃糊壁纸。终末地是科幻 HUD 皮肤，颜色仍可自定义。',
  themeSurfaceFlat: '默认',
  ...
  settingsTerminalHint: '允许斜杠指令、技能和终端命令。默认关闭，不必重启即可生效。',
  ...
  settingsExt: '扩展',
  settingsExtHint: 'Grok CLI 的插件、市场、Hooks 和 workflow，不是 OpenGrok 界面插件。',
  settingsPlugins: 'Grok 插件',
  settingsPluginsEmpty: '当前会话没有加载 Grok CLI 插件。',
  ogPlugins: 'OpenGrok 插件',
  ogPluginsHint:
    '放在 ~/.opengrok/plugins 的本地脚本，用来改界面或夹宿主逻辑。文件夹或带 ui.js / host.js / style.css 的 zip 都能加载。不是 Grok 市场插件。',
  ogPluginsEmpty: '还没有 OpenGrok 插件。在 ~/.opengrok/plugins 下放文件夹或 zip，内含 ui.js、host.js 或 style.css。',
  ogPluginsOpenDir: '打开插件目录',
  ogPluginsReload: '重新加载插件',
  ogPluginsHasUi: '界面',
  ogPluginsHasHost: '宿主',
  dockTools: '工具',
  dockTerminal: '终端',
  dockBrowser: '浏览器',
  dockF12: '打开开发者工具',
  dockUrlPlaceholder: '输入网址后回车',
  dockBrowserEmpty: '粘贴或输入 URL 以打开网页。',
  dockCopyUrl: '复制网址',
  dockOpenExternal: '在浏览器中打开',
  dockTermPlaceholder: '输入命令',
  dockCollapse: '收起面板',
  dockNewTab: '新标签页',
  dockResize: '拖拽调整宽度',
  dockOpenTab: '打开标签页',
  ...
  dockCloseTab: '关闭标签',
  dockCloseOthers: '关闭其他标签',
  dockCloseAll: '关闭所有标签',
  dockSearchTabs: '搜索标签页...',
  dockOpenTabs: '打开的标签页',
  dockRecentTabs: '最近关闭的标签页',
  dockAgeMin: '{n}分',
  dockAgeHour: '{n}小时',
  dockAgeDay: '{n}天',
  close: '关闭',
  ...
  goalStatus: '目标状态',
  goalStartHint: '写下目标后发送',
  goalFollowHint: '给进行中的目标补一句',
  goalResumeHint: '发送以继续，或点播放',
  ...
  loginWaitBody: '请在刚打开的页面完成登录。若回跳未完成，可���新打开或粘贴验证码。',
  ...
  turnRetrying: '正在重��� {n}/{max}',
  errorCode: '错误码 {code}',
  errorUntrustedCert:
    '证书不被信任。请把中转站 CA 装进系���，或设置 GROK_EXTRA_CA_BUNDLE 指向它的 PEM。',
  errorApiKeyRejected:
  ...
  starter1: '解���这个仓库是怎么组织的',
  starter2: '检查我打开的文件里的���题',
  starter3: '给最近的改动写测试',
  cardExplore: '摸清仓库结构与实现',
  cardBuild: '实现新功能或小工具',
  cardReview: '审查代码并给出改动',
  cardFix: '排查失败与回归',
  recent: '最近',
  you: '你',
  grok: 'Grok',
  ...
  railConfig: '配置与登录',
  railProject: '项目',
  railPickProject: '打开文件夹',
  railNoProject: '未选择文件夹',
  railSearch: '搜索会话',
  railSearchEmpty: '没有匹配的会话',
  railHistory: '历史',
  homeHintDesk: '点卡片填入输入框，确认后再发送。/ 命令，@ 文件。',
  shortcutNew: '新会话 (Ctrl+N)',
  shortcutSettings: '设置 (Ctrl+,)',
  shortcutFind: '搜索会话 (Ctrl+K)',
  shortcutComposer: '聚焦输入框 (Ctrl+L)',
  winMin: '最小化',
  winMax: '最大化',
  winRestore: '还原',
  winClose: '关闭',
  ...
  petBubbles: '气泡设置',
  petBubblesOn: '任务提示框',
  petBubblesHint: '工作时在团子上方显示一条状态芯片。',
  petInk: '墨黑',
  petPaper: '纸白',
  petIce: '冰蓝',
  petMoss: '苔绿',
  ...
  setMainColor: '主色',
  setAccent: '强调色',
  setMainColorHint: '文字和组件会按这个颜色自动选黑或白。',
  setUnofficial: '非官方桌面工作台，连接本机 Grok Build CLI。不是 xAI 产品。',
  setAboutLicense: 'Apache-2.0。真正跑任务的是这台机器上的 grok CLI。',
  setBackApp: '返回应用',
  setSearch: '搜索设置...',
  setGroupPerson: '个人',
  setGroupSystem: '系统',
  ...
  setOfficial: '官方账户',
  setProviders: '自定义提供商',
  setAccountHint: '使用 Grok Build 官方登录，查看 SuperGrok 额度与官方模型。',
  setQuotaLeft: '{n}% 剩余',
  setQuotaUsed: '已用 {n}%',
  setQuotaReset: '重置 {when}',
  setQuotaWeb: '在网页查看用量',
  setQuotaManage: '管理订阅',
  setSwitchAccount: '切换账号',
  setWhatsNew: '更新公告',
  setTour: '产品导览',
  setThemeMenu: '主题',
  heatTitle: '活动热力图',
  ...
  heatLongest: '最长聊天',
  heatStreak: '当前连续',
  heatLongestStreak: '最长连续',
  heatDays: '{n} 天',
  heatLess: '少',
  heatMore: '多',
  heatEmpty: '暂无本地活动',
  heatLoading: '正在加载活动…',
  heatTip: '{date} · {tokens} Token · {sessions} 个会话',
  setVersion: '版本 {v}',
  updateTitle: '更新',
  updateCheck: '检查更新',
  updateChecking: '正在检查更新…',
  updateIdle: '从 GitHub 检查是否有新版本。',
  updateLatest: '已是最新版本。',
  updateAvailable: '发现新版本 {v}。',
  updateDownload: '下载',
  updateDownloading: '正在下载 {p}%',
  updateReady: '版本 {v} 已下载，重启后安装。',
  updateNow: '立即重启安装',
  updateAuto: '自动更新',
  updateAutoHint: '后台下载新版本。退出时安装，或点立即重启安装。',
  updateFailed: '更新失败：{e}',
  updateDev: '开发模式不检查更新，安装包才会自动更新。',
  cronTitle: '定时任务',
  ...
  placeholderDesk: '给 OpenGrok 发消息，或输入 /',
  loginTitleDesk: '登录 OpenGrok',
  loginBodyDesk: '和 CLI 一样，用 grok.com 账号。支持 SuperGrok、X Premium+ 或 xAI API 密钥。',
};
